...
namespace TestWebApi.Controllers
{
    ...
    public class ClientInfoCache
    {
        ...
        private static Dictionary<string, ClientInfo> LoadClientInfo()
        {
            ...
            {
                //文件路径
                string filePath = HttpRuntime.AppDomainAppPath + "/App_Data/";
                ...
                if (File.Exists(filePath + fileName))
                {
                    ...
                    //解密数据，json数据转为对象进行缓存
                    string jsonStrInfo = CommonLibrary.DESUtil.DESDeCode(enStrInfo, desKey);
        ...
        private static void SaveClientInfo()
        {
            System.Threading.ThreadPool.QueueUserWorkItem(m =>
            {
                try
                {
                    ...
                    {
                        //string abc = HttpRuntime.AppDomainAppPath;
                        //abc = AppDomain.CurrentDomain.RelativeSearchPath;
                        string filePath = HttpRuntime.AppDomainAppPath + "/App_Data/";
                        ...
                        string enStrInfo = CommonLibrary.DESUtil.DESEnCode(strClientInfo, desKey);
